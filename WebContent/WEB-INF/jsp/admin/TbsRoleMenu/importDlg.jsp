...
<script type="text/javascript">
	//导入
	$("#tbsRoleMenuImport").uploadify({
	    //'height' : '18',
	    //'width' : '50',
	    'swf' : '${demoPath}static/js/uploadify/uploadify.swf',
	    'uploader' : '${demoPath}admin/TbsRoleMenu/import.html;jsessionid=<%=session.getId()%>',
...
<div id="tbsRoleMenuImportDlg">
	<a href="javascript:void(0)" id="tbsRoleMenuImport">导入</a>
</div>