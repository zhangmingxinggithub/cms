...
<script type="text/javascript">
	//导入
	$("#tbsUserImport").uploadify({
	    //'height' : '18',
	    //'width' : '50',
	    'swf' : '${demoPath}static/js/uploadify/uploadify.swf',
	    'uploader' : '${demoPath}admin/TbsUser/import.html;jsessionid=<%=session.getId()%>',
...
<div id="tbsUserImportDlg">
	<a href="javascript:void(0)" id="tbsUserImport">导入</a>
</div>