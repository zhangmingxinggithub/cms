...
<script type="text/javascript">
	//导入
	$("#tbsRoleImport").uploadify({
	    //'height' : '18',
	    //'width' : '50',
	    'swf' : '${demoPath}static/js/uploadify/uploadify.swf',
	    'uploader' : '${demoPath}admin/TbsRole/import.html;jsessionid=<%=session.getId()%>',
...
<div id="tbsRoleImportDlg">
	<a href="javascript:void(0)" id="tbsRoleImport">导入</a>
</div>