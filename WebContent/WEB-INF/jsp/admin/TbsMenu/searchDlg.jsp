		...
		<table>
			...
			<tr>
				...
				<td>
					...
					<td><input name="searchVals" size="18"> <a href="javascript:void(0)">日期框</a> <a href="javascript:void(0)" onclick="tbsMenuSearchRemove(this)">删除</a>
				</td>
			</tr>
		</table>
	</form>
