			...
			<tr>
				...
				<td>
					<select name="searchColumnNames">
						...
						<option value="isAdmin">权限类型</option>
					</select>
				</td>
				<td>
					...
					<td><input name="searchVals" size="18"> <a href="javascript:void(0)">日期框</a> <a href="javascript:void(0)" onclick="tbsUserSearchRemove(this)">删除</a>
				</td>
			</tr>
		</table>
	</form>
