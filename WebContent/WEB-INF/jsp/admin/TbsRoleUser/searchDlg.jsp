			...
			<tr>
				...
				<td>
					<select name="searchColumnNames">
						...
						<option value="userId">用户主键</option>
				...
				<td>
					...
					<td><input name="searchVals" size="18"> <a href="javascript:void(0)">日期框</a> <a href="javascript:void(0)" onclick="tbsRoleUserSearchRemove(this)">删除</a>
				</td>
			</tr>
		</table>
	</form>
