...
<script type="text/javascript">
	//导入
	$("#tbsRoleUserImport").uploadify({
	    //'height' : '18',
	    //'width' : '50',
	    'swf' : '${demoPath}static/js/uploadify/uploadify.swf',
	    'uploader' : '${demoPath}admin/TbsRoleUser/import.html;jsessionid=<%=session.getId()%>',
...
<div id="tbsRoleUserImportDlg">
	<a href="javascript:void(0)" id="tbsRoleUserImport">导入</a>
</div>