...
<script type="text/javascript">
	//导入
	$("#tbsLoginLogImport").uploadify({
	    //'height' : '18',
	    //'width' : '50',
	    'swf' : '${demoPath}static/js/uploadify/uploadify.swf',
	    'uploader' : '${demoPath}admin/TbsLoginLog/import.html;jsessionid=<%=session.getId()%>',
...
<div id="tbsLoginLogImportDlg">
	<a href="javascript:void(0)" id="tbsLoginLogImport">导入</a>
</div>